...
DevSpace accepts an optional `name` field:
...
Configuring a dependency name allows the use of the `--dependency` option on the command line to refer to specific dependencies.
